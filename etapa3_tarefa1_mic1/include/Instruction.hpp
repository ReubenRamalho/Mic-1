...
public:
   ...
   * @param memoryBits trecho da memória da palavra original lida do arquivo.
  ...
  /**
   * @brief Retorna o trecho referente à memória da palavra original.
   * @return String com os 2 bits correspondentes à memória.
   */
  std::string getMemoryBits() const;
